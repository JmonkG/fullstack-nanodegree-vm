...
CREATE FUNCTION return_Players(out id int,out name varchar(30),out win int,out los int) RETURNS SETOF record AS $$ SELECT * from Players ORDER BY Wins DESC; $$ LANGUAGE SQL;
